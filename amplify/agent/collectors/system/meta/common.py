...
class CommonSystemMetaCollector(AbstractCollector):
    """
    Common meta collector.  Meta information shared by all our support system objects (Linux, Centos, Docker, etc.) are
    collected here.
    """
    short_name = 'common_sys_meta'

    def __init__(self, **kwargs):
        super(CommonSystemMetaCollector, self).__init__(**kwargs)
